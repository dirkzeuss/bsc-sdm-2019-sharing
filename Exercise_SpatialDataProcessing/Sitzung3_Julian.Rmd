...
library(sp)
install.packages("raster", repos = "https://ftp.gwdg.de/pub/misc/cran/")
library(raster)
install.packages("maps", repos = "https://ftp.gwdg.de/pub/misc/cran/")
library(maps)
install.packages("maptools", repos = "https://ftp.gwdg.de/pub/misc/cran/")
library(maptools)
...
SPDF_1 <- st_set_crs(SPDF, "+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0") 
