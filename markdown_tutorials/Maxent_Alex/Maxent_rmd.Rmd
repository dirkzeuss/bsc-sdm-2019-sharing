...
In the End, you should receive a map, which looks somehow like this

![](maxent_s7.png)<!-- -->

In this map, blue pixels will indicate a low fit for the certain species to live there. Green will show a well fit and where one will probably find the species. Red pixels show the spots with the best fit for this species.

The white points show where the species has been found in your sample data. Black pixels indicate no data, which is because there is an ocean.
